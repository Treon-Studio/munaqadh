...
export const dropdownMenuStyles = tv({
  slots: {
    ...
    content: [
      'z-50 min-w-[8rem] overflow-hidden rounded-md border bg-popover p-1 text-[#555555] shadow-sm',
      // Entry animations
    ...
    item: [
      ...
      'transition-colors focus:bg-accent focus:text-[#555555] [&>svg]:size-4 [&>svg]:shrink-0',
      'data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
    ],
    checkboxItem: [
      'relative flex cursor-default select-none items-center rounded-xs py-1.5 pr-2 pl-8 text-sm',
      'outline-none transition-colors focus:bg-accent focus:text-[#555555]',
      'data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
    ],
